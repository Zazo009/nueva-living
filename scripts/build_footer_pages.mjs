...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="section"><div class="section-inner"><div class="section-head"><span class="label">Area Guide</span><div class="rule"></div><h2 class="section-title">Find the area that <em>fits you</em></h2><p class="body-copy">We look at what it is actually like to live there, how easy it is to get around and what supports long-term demand.</p></div><div class="area-stack">
      ...
      <a class="area-row" id="san-pedro-alcantara" href="area-san-pedro-alcantara.html" aria-label="Explore the San Pedro de Alcantara area guide"><img src="assets/liora/areas/san-pedro-alcantara.jpg" alt="Palm-lined seafront promenade at San Pedro de Alcántara, with the beach and the Mediterranean beyond" width="1920" height="1280" loading="lazy" decoding="async"><div class="area-copy"><span class="label">San Pedro de Alcantara</span><h3>A town, not a resort</h3><p>A street grid with a market and a school run, minutes from Puerto Ban&uacute;s, and cheaper than the addresses on either side of it. The beachside strip and the pueblo are two different markets.</p><span class="area-explore">Explore San Pedro de Alcantara</span></div></a>
    ...
    <section class="section section--tint" id="area-prices"><div class="section-inner"><div class="section-head"><span class="label">Area Prices</span><div class="rule"></div><h2 class="section-title">What the areas cost</h2><p class="body-copy">Asking-price averages for resale homes, which is the clearest way to compare one municipality against another. New developments sit above these figures, and a prime micro-location sits well above them.</p></div><div class="area-price-table-wrap"><table class="area-price-table"><thead><tr><th scope="col">Municipality</th><th scope="col">Average asking price</th><th scope="col">Best for</th></tr></thead><tbody><tr><th scope="row"><a href="area-marbella.html">Marbella</a></th><td>€5,608 / m²</td><td>Buyers who want an established international base with year-round services.</td></tr><tr><th scope="row"><a href="area-estepona.html">Estepona</a></th><td>€4,329 / m²</td><td>Buyers seeking a practical coastal base with more value range than central Marbella.</td></tr><tr><th scope="row"><a href="area-casares.html">Casares</a></th><td>€4,242 / m²</td><td>Buyers who want new-build near the coast at below Estepona pricing, and are comfortable driving for services.</td></tr><tr><th scope="row"><a href="area-benahavis.html">Benahavís</a></th><td>€5,413 / m²</td><td>Buyers prioritising privacy, security, golf and larger indoor-outdoor spaces.</td></tr><tr><th scope="row"><a href="area-nueva-andalucia.html">Nueva Andalucía</a></th><td>€6,048 / m²</td><td>Second-home and full-time buyers who value convenience, golf and established services.</td></tr><tr><th scope="row"><a href="area-san-pedro-alcantara.html">San Pedro de Alcántara</a></th><td>€4,600 / m²</td><td>Buyers who want a year-round town within minutes of Puerto Banús, below Marbella pricing.</td></tr><tr><th scope="row"><a href="area-mijas-fuengirola.html">Mijas &amp; Fuengirola</a></th><td>€3,773 / m²</td><td>Buyers prioritising everyday convenience, transport links and a broader price range.</td></tr></tbody></table></div><p class="area-price-source">Figures are resale asking-price averages from June 2026, except San Pedro de Alc&aacute;ntara, which is August 2026 on Idealista&rsquo;s revised method and is therefore an approximate comparison. Nueva Living confirms the current price of any individual home in writing.</p></div></section>
  ...
  },
  {
    ...
    <section class="section quiet-band"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">What It Pays</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">What the guarantee <em>actually returns</em></h2></div>
      <p class="body-copy g-reveal">A guarantee is not compensation for a purchase that went wrong. It is a return of what you handed over, and knowing its edges is what stops it being mistaken for something wider.</p>
      <div class="guide-compare-grid g-reveal">
        <div class="guide-compare-row"><div class="guide-compare-label">Covered</div><div><p>The amounts paid on account, the taxes charged on those amounts, and statutory interest from the date each payment was made.</p></div></div>
        <div class="guide-compare-row"><div class="guide-compare-label">Not covered</div><div><p>The gain you expected. If the finished market moved while you waited, the guarantee returns your money and not the difference. It restores your position; it does not deliver the bargain.</p></div></div>
        <div class="guide-compare-row"><div class="guide-compare-label">Also not covered</div><div><p>Costs you incurred around the purchase -- legal fees, travel, a mortgage arrangement fee already paid. Those sit outside the statutory guarantee and belong to whatever your contract says about them.</p></div></div>
      </div>
    </div></section>

    <section class="section"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">Checking Yours</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">How to confirm <em>yours actually exists</em></h2></div>
      <p class="body-copy g-reveal">A guarantee that exists at the level of the development is not the same as one issued for your payments. These are the four things to establish, in this order, and none of them requires taking anyone's word for it.</p>
      <div class="cards g-reveal">
        <article class="card"><h3>The licence</h3><p>Ask whether the building licence has been granted, and for the date. Before that point the statutory guarantee has not yet arisen, however the reservation is described.</p></article>
        <article class="card"><h3>The account</h3><p>The contract should identify the credit institution and the special account, and your payments should go there rather than to a general company account. Compare the account on the contract with the one on the payment instruction.</p></article>
        <article class="card"><h3>The document</h3><p>Ask for the certificate or policy that covers your payments specifically. It should name you, name the unit, and state the amounts. A master policy for the development is the frame, not the cover.</p></article>
        <article class="card"><h3>The issuer</h3><p>Check the insurer or bank named on it is authorised to operate in Spain. This takes one search and it is the step people skip.</p></article>
      </div>
      <p class="body-copy g-reveal">Keep the document. The failure this provision was written to prevent is not a developer refusing to pay -- it is a buyer discovering, years later, that nothing was ever issued in their name.</p>
    </div></section>

    <section class="section quiet-band"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">If It Fails</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">Why you are not <em>a creditor in a queue</em></h2></div>
      <p class="body-copy g-reveal">This is the part that explains the whole design. If a developer becomes insolvent, unsecured creditors line up against whatever the estate holds, and that process is slow and rarely whole.</p>
      <p class="body-copy g-reveal">A guaranteed buyer is not in that queue. The claim runs against the insurer or the bank that issued the guarantee, which is a solvent third party with its own obligation to you, and it does not depend on what the developer has left. That is the difference the paperwork buys, and it is why a guarantee held in your own name matters more than a reassurance that the development is covered.</p>
    </div></section>

    <section class="section segment-faq-section"><div class="section-inner">
      <div class="section-head"><span class="label">Common Questions</span><div class="rule"></div><h2 class="section-title">What buyers <em>ask us about guarantees</em></h2></div>
      <div class="segment-faq-list">
        <details class="segment-faq-item" open>
          <summary>Is my reservation fee guaranteed?</summary>
          <p>Only once the building licence has been granted. Paid before that, it rests on the wording of your reservation agreement instead, which is a contractual protection rather than a statutory one, and it differs between developers.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Who pays for the guarantee?</summary>
          <p>The developer. It is their obligation and their cost, and it should not appear as a charge added to your payments. If it does, ask what it is.</p>
        </details>
        <details class="segment-faq-item">
          <summary>What if the developer refuses to give me the document?</summary>
          <p>That is a reason to stop rather than to press on. The obligation to hand it over sits with them, and a developer who will not produce it at signing is telling you something about how the rest of the purchase will go.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Does the guarantee cover a delay, or only non-delivery?</summary>
          <p>It is triggered where construction does not begin, is not finished within the agreed period, or the habitation certificate is not obtained. A delay that runs past the agreed period reaches it; a delay inside that period is a contract question.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Does it transfer if I assign the contract?</summary>
          <p>Not automatically in the sense that matters. Where a contract is assigned, the guarantee has to follow the new buyer in writing, and that is a step to confirm rather than assume.</p>
        </details>
      </div>
    </div></section>
  ...
  },
  {
    ...
    <section class="section"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">The Real Number</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">What 30% at contract <em>actually costs</em></h2></div>
      <p class="body-copy g-reveal">Schedules are quoted net of VAT, so every percentage on them understates the transfer by a tenth. On a &euro;600,000 home the difference is not academic.</p>
      <div class="guide-compare-grid g-reveal">
        <div class="guide-compare-row"><div class="guide-compare-label">Reservation</div><div><p>&euro;10,000, usually counted towards the next stage rather than added to it.</p></div></div>
        <div class="guide-compare-row"><div class="guide-compare-label">At contract, 30%</div><div><p>&euro;180,000 net, less the &euro;10,000 already paid, plus 10% IVA on the &euro;180,000. The transfer is &euro;188,000, not &euro;170,000.</p></div></div>
        <div class="guide-compare-row"><div class="guide-compare-label">At the deed, 70%</div><div><p>&euro;420,000 net plus IVA on that, plus the AJD on the full price, plus notary, registry and legal. Around &euro;476,000 before fees.</p></div></div>
      </div>
      <p class="body-copy g-reveal">Read a schedule as net figures and add a tenth to each. A plan that looks like 30/70 is closer to 33/77 of the price in cash terms, and that is the number to hold against your own liquidity.</p>
    </div></section>

    <section class="section quiet-band"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">Before Signing</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">What to check <em>in the schedule itself</em></h2></div>
      <p class="body-copy g-reveal">Two schedules can quote identical percentages and behave completely differently, because what triggers a payment is set by wording rather than by the number beside it.</p>
      <div class="cards g-reveal">
        <article class="card"><h3>What triggers each stage</h3><p>A date is a promise. A certified construction milestone -- foundation complete, structure complete -- is an event someone signs off. Milestone-linked schedules move with the build; date-linked ones ask you to pay on time whether or not the build did.</p></article>
        <article class="card"><h3>Who certifies it</h3><p>Where payments follow milestones, the schedule should say who confirms one has been reached. In practice that is the project's technical architect, and the certificate is a document you can ask to see.</p></article>
        <article class="card"><h3>How much notice you get</h3><p>Fifteen days is common, and it is short if funds have to move across borders. Establish the notice period before you sign rather than discovering it with a payment demand.</p></article>
        <article class="card"><h3>What happens if you are late</h3><p>Contracts vary widely: interest, a cure period, and in some cases termination with retention of part of what you have paid. This is one of the clauses worth reading closely, because it is the one that costs the most when it applies.</p></article>
      </div>
    </div></section>

    <section class="section"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">Currency and Timing</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">The cost that <em>is not in the schedule</em></h2></div>
      <p class="body-copy g-reveal">If your money is not in euros, a staged purchase is a series of conversions rather than one, and the schedule says nothing about that.</p>
      <p class="body-copy g-reveal">A build running two or three years means four or five transfers, each at whatever the rate is that week. Buyers who fix the rate forward for known dates trade the chance of a better rate for a known number, which is a decision worth taking deliberately rather than by default. Where the schedule is milestone-linked rather than date-linked, forward cover is harder to arrange, and that is a real argument for asking which kind you are being offered.</p>
    </div></section>

    <section class="section segment-faq-section"><div class="section-inner">
      <div class="section-head"><span class="label">Common Questions</span><div class="rule"></div><h2 class="section-title">What buyers <em>ask us about payments</em></h2></div>
      <div class="segment-faq-list">
        <details class="segment-faq-item" open>
          <summary>Can I negotiate the payment schedule?</summary>
          <p>Sometimes, and more often on the timing than the totals. Developers with financing tied to pre-sales have less room than those releasing later phases. It is always worth asking, and the answer tells you something about the project either way.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Can I pay more upfront for a discount?</summary>
          <p>Occasionally offered, and worth weighing carefully: paying ahead of the schedule increases what you have at risk before delivery, and the guarantee covers what you have paid rather than what you were promised in return.</p>
        </details>
        <details class="segment-faq-item">
          <summary>What if I cannot make a stage payment?</summary>
          <p>Tell the developer before the date rather than after. Most contracts allow for a cure period and interest, and a conversation held early is a different conversation from one held after a default has been declared.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Do stage payments go to the developer directly?</summary>
          <p>They should go to the special account named in your contract, held apart from the developer's other funds, once the guarantee regime applies. Compare the account on the contract against the one on the payment instruction each time.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Does a longer schedule mean a better deal?</summary>
          <p>Not by itself. Spreading payments helps your cash flow and increases the period over which you are exposed to the build completing. Which matters more depends on your own position, not on the shape of the schedule.</p>
        </details>
      </div>
    </div></section>
  ...
  },
  {
    ...
    <section class="section quiet-band"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">The Tax Gap</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">Four points <em>separate them</em></h2></div>
      <p class="body-copy g-reveal">Most comparisons stop at the asking price. In Andaluc&iacute;a the two purchases are taxed differently, and the difference is large enough to change which one is actually cheaper.</p>
      <div class="guide-compare-grid g-reveal">
        <div class="guide-compare-row"><div class="guide-compare-label">New-build</div><div><p>IVA at 10% plus AJD at 1.2%, so 11.2% of the price in tax. Both are set by law and neither is negotiable.</p></div></div>
        <div class="guide-compare-row"><div class="guide-compare-label">Resale</div><div><p>ITP at 7% and no AJD. Four points lower, on the same price.</p></div></div>
        <div class="guide-compare-row"><div class="guide-compare-label">What it means</div><div><p>A resale at the same headline price costs roughly &euro;18,000 less in tax on a &euro;450,000 purchase. An off-plan unit has to be priced meaningfully below the finished comparable before it is the cheaper transaction, not merely the cheaper number.</p></div></div>
      </div>
      <p class="body-copy g-reveal">That does not settle the question. It does mean the comparison is not the one the asking prices suggest, and it belongs in the arithmetic before anything else.</p>
    </div></section>

    <section class="section"><div class="section-inner">
      <div class="section-head center g-reveal"><span class="label">Resale Risk</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">What a resale carries <em>that a new-build does not</em></h2></div>
      <p class="body-copy g-reveal">Off-plan risk is easy to name: the building might be late. Resale risk is quieter, because it arrives attached to the property rather than to the timeline.</p>
      <div class="cards g-reveal">
        <article class="card"><h3>Debts follow the home</h3><p>Unpaid community charges attach to the property itself for the current year and the three preceding ones, and unpaid IBI attaches to it without a time limit of that kind. Your lawyer asks for a certificate of no debt from the community and checks the IBI receipts before you sign.</p></article>
        <article class="card"><h3>The 3% retention</h3><p>Where the seller is not resident in Spain, the buyer withholds 3% of the price and pays it to the tax office on the seller's account. It is the buyer's obligation, not the seller's courtesy, and it does not arise at all buying from a developer.</p></article>
        <article class="card"><h3>Licence history</h3><p>Extensions, glazed terraces and pool houses added without permission are common and do not always appear in the deed. What is registered, what is built and what was licensed have to agree, and only a search establishes that.</p></article>
        <article class="card"><h3>No warranty behind it</h3><p>A new-build carries statutory cover against defects. A resale carries whatever remains of the original periods, which on an older home is usually nothing, so a survey does the work a warranty would.</p></article>
      </div>
      <p class="body-copy g-reveal">None of this makes resale the worse choice. It makes the diligence different: on off-plan you are checking a developer and a licence, and on a resale you are checking a building and its history.</p>
    </div></section>

    <section class="section segment-faq-section"><div class="section-inner">
      <div class="section-head"><span class="label">Common Questions</span><div class="rule"></div><h2 class="section-title">What buyers <em>ask us when deciding</em></h2></div>
      <div class="segment-faq-list">
        <details class="segment-faq-item" open>
          <summary>Is off-plan actually cheaper?</summary>
          <p>At the same headline price, no, because the tax is four points higher. Off-plan is cheaper where the price genuinely sits below the finished comparable by more than that, which is a project-by-project question rather than a rule.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Can I get a mortgage on an off-plan purchase?</summary>
          <p>Yes, but the loan is normally drawn at completion rather than during construction, so the stage payments come out of your own funds. That changes the cash profile more than the total, and it is worth modelling before you reserve.</p>
        </details>
        <details class="segment-faq-item">
          <summary>What happens if the development is delayed?</summary>
          <p>Delays of a few months against the original estimate are common. Your contract sets the delivery date and what happens if it is missed, including whether you may terminate or grant an extension, and that clause is worth reading before you sign rather than after.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Can I sell an off-plan unit before completion?</summary>
          <p>Sometimes. Whether the contract can be assigned to another buyer, and on what terms and fee, is set by the developer and varies widely. If that is part of your plan, establish it in writing before reserving, not later.</p>
        </details>
        <details class="segment-faq-item">
          <summary>Which one rents better?</summary>
          <p>A completed home can be let immediately, which is a real advantage where income matters from day one. Beyond that, letting depends on the specific development's rules and the local licensing regime rather than on whether the home was bought off-plan.</p>
        </details>
      </div>
    </div></section>
