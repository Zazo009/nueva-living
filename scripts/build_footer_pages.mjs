...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="ambassador-manifesto"><div class="section-inner ambassador-manifesto-inner ambassador-reveal">
      <div class="rule" style="margin-left:auto;margin-right:auto;"></div>
      <p class="ambassador-manifesto-quote">The best homes on the Costa del Sol rarely reach the open market through advertising alone. They move through conversations &mdash; a friend who already trusts us, a colleague who found the right place and wants someone they care about to find theirs too. That is the introduction Nueva Living exists to reward.</p>
    </div></section>
    <section class="section"><div class="section-inner split ambassador-reveal">
      <div class="image-panel"><img src="assets/liora/projects/jardin-del-mar-residences/media/dining-terrace-sea-view.jpg" alt="Private dining terrace with a Costa del Sol sea view" width="1920" height="1364" loading="lazy" decoding="async"></div>
      <div><span class="label">Before You Introduce Someone</span><div class="rule"></div><h2 class="section-title">What makes a strong <em>introduction</em></h2><p class="body-copy">The introductions that go furthest are usually simple. Someone has already mentioned, in a conversation that happened naturally, that they are thinking about a home on the Costa del Sol. You do not need to sell them on Nueva Living &mdash; just let us pick up the conversation from there.</p><p class="body-copy">A few things tend to make an introduction genuinely useful to us: they are seriously considering a purchase, not just idly browsing; they have not already been in contact with another Costa del Sol agency about new-build options; and they are open to us reaching out directly, on your recommendation.</p></div>
    </div></section>
    <section class="section ambassador-reveal"><div class="section-inner"><div class="section-head"><span class="label">How It Works</span><div class="rule"></div><h2 class="section-title">A simple way to <em>say thank you</em></h2></div>
      <div class="ambassador-timeline">
        <div class="ambassador-timeline-step ambassador-reveal" style="--reveal-delay:0ms">
          <span class="ambassador-timeline-index">01</span>
          <div class="ambassador-timeline-body"><h3>Tell Us Who to Introduce</h3><p>Share your friend or contact's details using the form below, along with a little about what they are looking for &mdash; area, budget, timing, anything you already know.</p></div>
        </div>
        <div class="ambassador-timeline-step ambassador-reveal" style="--reveal-delay:90ms">
          <span class="ambassador-timeline-index">02</span>
          <div class="ambassador-timeline-body"><h3>We Confirm It Is a Genuine Introduction</h3><p>We check whether your contact is already in touch with Nueva Living. If they are, we tell you honestly rather than let you assume a reward that will not apply.</p></div>
        </div>
        <div class="ambassador-timeline-step ambassador-reveal" style="--reveal-delay:180ms">
          <span class="ambassador-timeline-index">03</span>
          <div class="ambassador-timeline-body"><h3>We Look After Them, Properly</h3><p>We reach out and guide them through the same private, advisory-led process every Nueva Living client receives &mdash; no different treatment, no shortcuts, just because they came through you.</p></div>
        </div>
        <div class="ambassador-timeline-step ambassador-reveal" style="--reveal-delay:270ms">
          <span class="ambassador-timeline-index">04</span>
          <div class="ambassador-timeline-body"><h3>You Get Rewarded</h3><p>If they go on to complete a purchase through Nueva Living, you receive a share of our commission on that sale, confirmed with you in writing before any introduction is made.</p></div>
        </div>
      </div>
    </div></section>
    ...
    <section class="section quiet-band ambassador-reveal"><div class="section-inner"><div class="section-head"><span class="label">The Reward</span><div class="rule"></div><h2 class="section-title">A share of our commission, <em>paid on completion</em></h2><p class="body-copy">Not a discount off someone else's purchase and not a finder's fee for a name on a list -- a genuine share of what we earn, paid once your introduction has actually bought a home through us. We confirm the exact percentage and payment terms with you directly, in writing, before any introduction is made.</p></div></div></section>
    <section class="section ambassador-reveal"><div class="section-inner"><div class="section-head"><span class="label">Who Can Take Part</span><div class="rule"></div><h2 class="section-title">Open to <em>anyone</em></h2></div><div class="cards two">
    ...
    <section class="section quiet-band ambassador-reveal"><div class="section-inner"><div class="section-head"><span class="label">Good to Know</span><div class="rule"></div><h2 class="section-title">The <em>practical details</em></h2></div><div class="cards two">
    ...
    <section class="section ambassador-faq ambassador-reveal"><div class="section-inner"><div class="section-head"><span class="label">Common Questions</span><div class="rule"></div><h2 class="section-title">What ambassadors usually <em>ask us</em></h2></div>
      <div class="segment-faq-list">
        <details class="segment-faq-item" open><summary>How is my referral tracked once I submit it?</summary><p>The moment you submit the form below, we record the introduction against your name and contact details before we reach out to your friend. That record is what confirms your reward if a purchase later completes.</p></details>
        <details class="segment-faq-item"><summary>Is there a limit to how many people I can refer?</summary><p>No. You can introduce as many people as you like, and each genuine introduction is tracked and rewarded on its own.</p></details>
        <details class="segment-faq-item"><summary>What if my friend already has a Nueva Living project in mind?</summary><p>We will still help them find the right home. The reward itself applies specifically to introductions to people who are not already in touch with Nueva Living, since it is there to recognise bringing us a genuinely new client.</p></details>
        <details class="segment-faq-item"><summary>Can I refer someone who lives outside Spain?</summary><p>Yes. Many of our clients buy from abroad, so there is no restriction on where you or the person you introduce are based.</p></details>
        <details class="segment-faq-item"><summary>What if my friend contacts Nueva Living directly instead of through this form?</summary><p>Submitting the introduction yourself, before we hear from them independently, is what establishes it as your referral. If you are planning to introduce someone, let us know first.</p></details>
        <details class="segment-faq-item"><summary>How will I know if my referral leads to a sale?</summary><p>We keep you updated on the general progress of your introduction, within the bounds of your friend's own privacy, and confirm directly with you once a reward is due.</p></details>
      </div>
    </div></section>
    <section class="section ambassador-reveal" id="referral-form"><div class="section-inner"><div class="section-head center"><span class="label">Refer Someone</span><div class="rule"></div><h2 class="section-title">Introduce them <em>today</em></h2><p class="body-copy" style="margin-left:auto;margin-right:auto;">Share your details and theirs. We will take it from there.</p></div><form class="form-panel" id="referral-form-panel" name="nueva-referral-request" method="POST" data-crm-lead action="/.netlify/functions/nueva-lead"><input type="hidden" name="subject" data-remove-prefix value="New Nueva Living referral submission"><input type="hidden" id="referral-request-context" name="request_context" value="Referral &amp; Ambassador Program"><input type="hidden" name="message" id="referral-message"><div class="form-grid"><div class="field"><label for="ref-first-name">Your First Name</label><input id="ref-first-name" name="first_name" autocomplete="given-name" placeholder="First name" required></div><div class="field"><label for="ref-last-name">Your Last Name</label><input id="ref-last-name" name="last_name" autocomplete="family-name" placeholder="Last name" required></div><div class="field"><label for="ref-email">Your Email Address</label><input id="ref-email" name="email" type="email" autocomplete="email" placeholder="your@email.com" required></div><div class="field"><label for="ref-phone">Your Phone Number</label><input id="ref-phone" name="phone" type="tel" autocomplete="tel" placeholder="+34 or international"></div><div class="field"><label for="friend-name">Their Name</label><input id="friend-name" name="friend_name" placeholder="Who are you introducing?" required></div><div class="field"><label for="friend-contact">Their Email or Phone</label><input id="friend-contact" name="friend_contact" placeholder="How can we reach them?" required></div><div class="field full"><label for="friend-notes">What Are They Looking For?</label><textarea id="friend-notes" name="friend_notes" placeholder="Budget, area, property type, timing -- whatever you know."></textarea></div><label class="consent-row field full" for="ref-consent"><input id="ref-consent" name="consent" type="checkbox" required><span>I agree to be contacted and for my data to be stored.</span></label></div><div class="form-actions"><button class="btn" type="submit">Submit Referral</button><span class="form-response"></span></div></form></div></section>
    <script>
      (() => {
