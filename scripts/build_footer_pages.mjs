...
const pages = [
  ...
  },
  {
    ...
    <section class="section ambassador-faq ambassador-reveal"><div class="section-inner"><div class="section-head center"><span class="label">Common Questions</span><div class="rule" style="margin-left:auto;margin-right:auto;"></div><h2 class="section-title">What ambassadors usually <em>ask us</em></h2></div>
      <div class="segment-faq-list">
        <details class="segment-faq-item" open><summary>How is my referral tracked once I submit it?</summary><p>The moment you submit the form below, we record the introduction against your details before reaching out to your friend.</p></details>
        <details class="segment-faq-item"><summary>What if my friend already has a Nueva Living project in mind?</summary><p>We will still help them. The reward specifically recognises bringing us a genuinely new client, not someone already in touch with us.</p></details>
        <details class="segment-faq-item"><summary>What if my friend contacts Nueva Living directly first?</summary><p>Submitting the introduction yourself, before they reach out independently, is what establishes it as your referral.</p></details>
        <details class="segment-faq-item"><summary>How will I know if my referral leads to a sale?</summary><p>We keep you updated on progress, within the bounds of your friend's privacy, and confirm directly once a reward is due.</p></details>
      </div>
    </div></section>
