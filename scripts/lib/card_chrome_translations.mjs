...
export const CARD_CHROME_ENTRIES = [
  ...
  { find: 'dev-badge">Current release', es: 'dev-badge">Comercialización actual', fr: 'dev-badge">Commercialisation actuelle', de: 'dev-badge">Aktueller Verkaufsstand', ru: 'dev-badge">Актуальная продажа', ar: 'dev-badge">الطرح الحالي', nl: 'dev-badge">Actuele verkoop', pl: 'dev-badge">Aktualna oferta', sv: 'dev-badge">Aktuell försäljning', no: 'dev-badge">Gjeldende salg' },
