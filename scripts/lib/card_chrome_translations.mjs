...
export const CARD_CHROME_ENTRIES = [
  ...
  { find: 'dev-fact-sub">Current Release', es: 'dev-fact-sub">Fase actual', fr: 'dev-fact-sub">Phase actuelle', de: 'dev-fact-sub">Aktuelle Phase', ru: 'dev-fact-sub">Текущая очередь', ar: 'dev-fact-sub">المرحلة الحالية', nl: 'dev-fact-sub">Huidige fase', pl: 'dev-fact-sub">Bieżąca pula', sv: 'dev-fact-sub">Aktuell fas', no: 'dev-fact-sub">Gjeldende fase' },
  { find: 'dev-fact-sub">Phase 2', es: 'dev-fact-sub">Fase 2', fr: 'dev-fact-sub">Phase 2', de: 'dev-fact-sub">Phase 2', ru: 'dev-fact-sub">Очередь 2', ar: 'dev-fact-sub">المرحلة 2', nl: 'dev-fact-sub">Fase 2', pl: 'dev-fact-sub">Etap 2', sv: 'dev-fact-sub">Fas 2', no: 'dev-fact-sub">Fase 2' },
  { find: 'dev-fact-sub">Phase 6', es: 'dev-fact-sub">Fase 6', fr: 'dev-fact-sub">Phase 6', de: 'dev-fact-sub">Phase 6', ru: 'dev-fact-sub">Очередь 6', ar: 'dev-fact-sub">المرحلة 6', nl: 'dev-fact-sub">Fase 6', pl: 'dev-fact-sub">Etap 6', sv: 'dev-fact-sub">Fas 6', no: 'dev-fact-sub">Fase 6' },
