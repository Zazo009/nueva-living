...
export const FLOOR_PARTS = {
  ...
  '2nd floor': { es: 'Segunda planta', fr: 'Deuxième étage', de: 'Zweites Obergeschoss', ru: 'Третий этаж', ar: 'الطابق الثاني', nl: 'Tweede verdieping', pl: 'Drugie piętro', sv: 'Andra våningen', no: 'Tredje etasje' },
