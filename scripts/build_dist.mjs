...
const basePageMeta = {
  ...
  'advisory.html': {
    ...
    path: '/advisory.html',
    type: 'article',
    // The FAQ schema for this page is derived from the FAQ it actually
    // renders, in build_footer_pages.mjs, so it exists in all ten languages
    // and cannot drift from the visible text. The hardcoded English copy
    // that used to sit here duplicated it on the English page and covered
    // no other language.
  },
  'guide-how-buying-works.html': {
...
const assetFiles = [
  ...
  'assets/liora/video/hero-desktop-v3.mp4',
