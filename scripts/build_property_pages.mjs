...
const CANCELADA_MAP_FIX = `  <style>
  ...
  <script>
    (function () {
      ...
      map.setAttribute('viewBox', '0 0 1200 820');
      ...
      map.innerHTML = [
        ...
        '<rect width="1200" height="820" fill="#f7f1e7"></rect>',
        '<path d="M0 560 C180 520 330 548 470 512 C650 466 810 486 1010 420 C1090 395 1150 370 1200 340 L1200 820 L0 820 Z" fill="#e8dfcd" opacity=".72"></path>',
        ...
        '<text x="180" y="660" class="map-sea">MEDITERRANEAN SEA</text>',
